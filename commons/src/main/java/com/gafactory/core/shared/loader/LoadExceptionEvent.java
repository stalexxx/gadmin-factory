...
public class LoadExceptionEvent<C> extends GwtEvent<LoadExceptionEvent.LoadExceptionHandler<C>> {
   ...
   * {@link com.gafactory.core.shared.loader.LoadExceptionEvent} events.
   */
  public interface HasLoadExceptionHandlers<C> {

    /**
     * Adds a {@link com.gafactory.core.shared.loader.LoadExceptionEvent} handler.
     * 
  ...
  /**
   * Handler class for {@link com.gafactory.core.shared.loader.LoadExceptionEvent} events.
   */
