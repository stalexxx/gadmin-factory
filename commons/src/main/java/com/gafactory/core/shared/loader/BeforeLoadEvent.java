...
import com.gafactory.core.shared.event.CancellableEvent;
...
public class BeforeLoadEvent<C> extends GwtEvent<BeforeLoadEvent.BeforeLoadHandler<C>> implements CancellableEvent {
  ...
  /**
   * Handler class for {@link com.gafactory.core.shared.loader.BeforeLoadEvent} events.
   */
  public interface BeforeLoadHandler<C> extends EventHandler {
     ...
     * {@link com.gafactory.core.shared.loader.BeforeLoadEvent#setCancelled(boolean)}.
     */
   ...
   * {@link com.gafactory.core.shared.loader.BeforeLoadEvent} events.
   */
  public interface HasBeforeLoadHandlers<C> {

    /**
     * Adds a {@link com.gafactory.core.shared.loader.BeforeLoadEvent} handler.
     * 
