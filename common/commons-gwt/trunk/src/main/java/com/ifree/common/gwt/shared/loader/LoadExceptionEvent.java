 ...
 */
public class LoadExceptionEvent<C> extends GwtEvent<LoadExceptionEvent.LoadExceptionHandler<C>> {

  /**
   * A loader that implements this interface is a public source of
   * {@link com.ifree.common.gwt.shared.loader.LoadExceptionEvent} events.
   */
  public interface HasLoadExceptionHandlers<C> {

    /**
     * Adds a {@link com.ifree.common.gwt.shared.loader.LoadExceptionEvent} handler.
     * 
  ...
  /**
   * Handler class for {@link com.ifree.common.gwt.shared.loader.LoadExceptionEvent} events.
   */
